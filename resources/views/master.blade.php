                ...
                <!-- User Menu-->
                    <li class="dropdown">
                        <a href="#" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                            ...
                            <a data-toggle="tooltip" title="View PMS Manual" href="{{asset('fileuploads/Documentation/Online_PMS_Documentation.pdf?ver=8thJuly')}}" target="_blank"><i class="icon icon-book-open"></i> </a><span><strong><a style="color:white; font-weight:bold;margin-right:5px;" href="@if(Auth::user()->RoleId != 1){{url('viewprofile')}}@else{{"#"}}@endif">{{Auth::user()->Name}}</a></strong> {{--<i class=" icofont icofont-simple-down"></i>--}}</span>
                        </a>
                    </li>
                    <li>
                        <strong><a style="color:#fff;" href="{{url("changepassword")}}"><i class="fa fa-key"></i> Change Password </a></strong>
                    </li>
                    @if(Session::has('FromSingleSignIn'))
                        <li>
                             <strong><a style="color:#fff;margin-left:10px;" href="{{url("officesuitedashboard")}}"><i class="fa fa-home"></i> Dashboard</a></strong>
                        </li>
                    @else
                        <li>
                             <strong><a style="color:#fff;margin-left:10px;" href="{{url("logout")}}" class="logout-confirm"><i class="fa fa-sign-out"></i> Logout</a></strong>
                        </li>
                    @endif
                </ul>
    ...
    <aside class="main-sidebar hidden-print " >
        ...
        <!-- Sidebar Menu-->
            <ul class="sidebar-menu">
                ...
                {{--</li>--}}
                @if($isAdmin)
                    <li class="treeview @if(in_array($currentRoute,['departmentindex','departmentinput','supervisorindex','supervisorinput','sectionindex','sectioninput','designationindex','designationinput','positionindex','positioninput','criteriainput','gradestepindex','gradestepinput','employeeindex','employeeinput','hierarchyindex','hierarchyinput','disciplinaryindex','disciplinaryinput'])){{"active"}}@endif"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span> Manage Master Data</span><i class="icon-arrow-down"></i></a>
                        <ul class="treeview-menu">
                            ...
                            <li class="treeview @if(in_array($currentRoute,['supervisorindex','supervisorinput'])){{"active"}}@endif">
                    ...
                    <li class="treeview @if(in_array($currentRoute,['appraisepms','eligibleforincentivereport','officeorderhistory','viewpmsdetails','closepms','finalizepms','generateofficeorder','officeorder'])){{"active"}}@endif"><a class="waves-effect waves-dark" href="#!"><i class="fa fa-file"></i><span> PMS</span><i class="icon-arrow-down"></i></a>
                        <ul class="treeview-menu">
                            ...
                            <li class="treeview @if(in_array($currentRoute,['eligibleforincentivereport'])){{"active"}}@endif">
                                <a class="waves-effect waves-dark " href="{{URL::to('eligibleforincentivereport')}}">
                    ...
                    @if(Auth::user()->Extension == 1234)
                        <li class="treeview @if($currentRoute == 'openpms'){{"active"}}@endif">
                            <a class="waves-effect waves-dark {{--openconfirm--}}" href="{{url('openpms')}}">
                ...
                @if((Auth::user()->EmpId <> '032') && ($isAdmin || $isAppraiser || in_array(Auth::user()->PositionId,[CONST_POSITION_HOD,CONST_POSITION_MD])))
                    <li class="treeview @if(in_array($currentRoute,['audittrailreport','organizationalperformance','departmentwiseperformance','sectionwiseperformance','pmscomparisionemployees','pmsscorereport'])){{"active"}}@endif"><a class="waves-effect waves-dark" href="#!"><i class="icon-graph"></i><span> Reports</span><i class="icon-arrow-down"></i></a>
                        <ul class="treeview-menu">
                            @if(!$isAppraiser)
