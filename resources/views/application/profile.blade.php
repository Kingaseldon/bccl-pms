                                    ...
                                    @foreach ($details as $userDetail)
                                        ...
                                        <tr>
                                            <td colspan="2" class="text-center">
                                                @if (!$hasParam)
                                                    <a href="#profilePicModal" data-toggle="modal"
                                                        class="btn btn-xs btn-inverse-primary"><i class="fa fa-edit"></i>
                                                        {{ (bool) $userDetail->ProfilePicPath ? 'Change' : 'Upload' }} Profile
                                                        Picture</a>
                                                @endif
                                                <br>
                                            </td>
                                        ...
                                        <tr>
                                            <th style="width:35%;">Date of Birth <span
                                                    class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                            <td style="padding-left:25px;">
                                                {{ (bool) $userDetail->DateOfBirth ? convertDateToClientFormat($userDetail->DateOfBirth) : 'N/A' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="width:35%;">Mobile <span
                                                    class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                        ...
                                        {{-- </tr> --}}
                                        <tr>
                                            <th style="width:35%;">Emp Id <span
                                                    class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                            <td style="padding-left:25px;"> {{ $userDetail->EmpId }}</td>
                                        </tr>
                                        <tr>
                                            <th style="width:35%;">CID<span class="pull-right d-none d-sm-block">:</span>
                                                &nbsp;&nbsp;</th>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table style="width:100%;" class="simple-table">
                                    @foreach ($details as $userDetail)
                                        <tr>
                                            <th style="width:35%;">Date of Appointment <span
                                                    class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                            <td style="padding-left:25px;">
                                                {{ (bool) $userDetail->DateOfAppointment ? convertDateToClientFormat($userDetail->DateOfAppointment) : 'N/A' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="width:35%;">Duration of Service <span
                                                    class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                            <td style="padding-left:25px;">
                                                <?php
                                        ...
                                        {{-- </tr> --}}
                                        <tr>
                                            <th style="width:35%;">Position Title <span
                                                    class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                            <td style="padding-left:25px;"> {{ $userDetail->DesignationLocation }}</td>
                                        </tr>
                                        <tr>
                                            <th style="width:35%;">Grade<span class="pull-right d-none d-sm-block">:</span>
                                                &nbsp;&nbsp;</th>
                                            <td style="padding-left:25px;"> {{ $userDetail->GradeStep ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <th style="width:35%;">Current Pay Scale<span
                                                    class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                        ...
                                        {{-- </tr> --}}
                                        <tr>
                                            <th style="width:35%;">Appraiser (Level 1) <span
                                                    class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                            <td style="padding-left:25px;"> {!! $userDetail->Level1Name ?? 'N/A' !!}</td>
                                        </tr>
                                        <tr>
                                            <th style="width:35%;">Appraiser (Level 2) <span
                                                    class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" accept=".PNG,.JPG,.JPEG,.GIF,.png,.jpg,.jpeg,.gif" id="Image"
                            required="required" name="Image" autocomplete="off" class="form-control" />
