                            ...
                            <div class="col-md-12 col-lg-12" style="padding-bottom:0;">
                                <div class="row">
                                    <div class="col-md-3 col-sm-9 text-left" style="padding-bottom:0;">
                                        <a href="{{url('departmentinput')}}" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        @forelse($departments as $department)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-xs btn-primary editconfirm" href="{{url('departmentinput',[$department->Id])}}"><i class="fa fa-edit"></i> Edit</a>&nbsp;&nbsp;<a class="btn btn-danger btn-xs deleteconfirm" href="{{url('departmentdelete',[$department->Id])}}"><i class="fa fa-times"></i> Delete</a>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
