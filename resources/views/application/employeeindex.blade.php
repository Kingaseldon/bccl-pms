                            ...
                            <div class="col-md-12 col-lg-12" style="padding-bottom:0;">
                                <div class="row">
                                    <div class="col-md-3 col-sm-9 text-left" style="padding-bottom:0;">
                                        <a href="{{url('employeeinput')}}" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add</a>
                                        <br><br>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{Request::url()}}" method="GET">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="GradeStepId" class="form-control select2" id="GradeStepId">
                                            ...
                                            @foreach($gradeSteps as $gradeStep)
                                                <option @if($gradeStep->Id == app('request')->input('GradeStepId'))selected="selected"@endif value="{{$gradeStep->Id}}">{{$gradeStep->Name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-4 col-8">
                                <div class="row">
                                    ...
                                    <a href="{{url('employeeindex')}}" style="" class="btn btn-danger"><i class="fa fa-times"></i> Clear</a>
                                </div>
                            </div>
                        </form>
                        <div class="row">
...
{{--                                                <td>{{$employee->Role}}</td>--}}
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class="btn btn-xs btn-primary editconfirm" href="{{url('employeeinput',[$employee->Id])}}?redirect=employeeindex{{$append}}"><i class="fa fa-edit"></i> Edit</a>&nbsp;&nbsp;
                                                    <a class="btn btn-danger btn-xs deleteconfirm" href="{{url('employeedelete',[$employee->Id])}}"><i class="fa fa-times"></i> Delete</a>&nbsp;&nbsp;
                                                    @if(Auth::user()->Extension == 1234)
                                                        <a class="btn btn-inverse-primary btn-xs" href="{{url('loginasemployee',[$employee->Id])}}"><i class="fa fa-sign-in"></i> Login As</a>&nbsp;&nbsp;
                                                    @endif
                                                </td>
                                            </tr>
                                        @empty
